...
const tocItems: TocItem[] = [
  ...
  { id: "epoch-synthetic-deception", title: "1. The Epoch of Synthetic Deception", level: 2 },
  { id: "anatomy-of-lie", title: "2. The Anatomy of the Lie", level: 2 },
  { id: "text-filters-gap", title: "3. Why Text Filters Can't See", level: 2 },
  { id: "spectral-forensics", title: "4. Spectral Forensics", level: 2 },
  { id: "sota-architectures", title: "5. Detection Architectures", level: 2 },
  { id: "adversarial-frontier", title: "6. The Adversarial Frontier", level: 2 },
  { id: "engineering-realtime", title: "7. Engineering for Real-Time", level: 2 },
        ...
        <div className="mx-auto max-w-5xl">
          <div className="lg:grid lg:grid-cols-[1fr_220px] lg:gap-12">
            ...
            <div className="max-w-3xl">
              ...
              >
                <h2 id="epoch-synthetic-deception" className="text-2xl font-bold text-gray-900 mt-12 mb-6 scroll-mt-24">
              ...
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <h2 id="anatomy-of-lie" className="text-2xl font-bold text-gray-900 mt-16 mb-6 scroll-mt-24">
              ...
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <h2 id="text-filters-gap" className="text-2xl font-bold text-gray-900 mt-16 mb-6 scroll-mt-24">
              ...
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <h2 id="spectral-forensics" className="text-2xl font-bold text-gray-900 mt-16 mb-6 scroll-mt-24">
              ...
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <h2 id="sota-architectures" className="text-2xl font-bold text-gray-900 mt-16 mb-6 scroll-mt-24">
              ...
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <h2 id="adversarial-frontier" className="text-2xl font-bold text-gray-900 mt-16 mb-6 scroll-mt-24">
              ...
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <h2 id="engineering-realtime" className="text-2xl font-bold text-gray-900 mt-16 mb-6 scroll-mt-24">
              ...
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <h2 id="conclusion" className="text-2xl font-bold text-gray-900 mt-16 mb-6 scroll-mt-24">
                ...
                <RelatedPosts currentSlug="detecting-deepfakes" />
              </motion.div>
            </div>
